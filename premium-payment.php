            ...
            if ($_FILES["image"]["error"] == 0) {
                ...
                if (in_array(strtolower($imageExtension), $validImageExtension) && $fileSize <= 10000000) {
                    ...
                    if (move_uploaded_file($tmpName, 'img/' . $newImageName)) {
                        ...
                        $stmt = $mysqli->prepare("INSERT INTO `payment-transaction-tb` (`transaction-id`,`email`, `client-gcash-name`, `client-gcash-num`,`transaction-num`, `transaction-img`,`subscription`, `UID`, `PID`) VALUES (?, ?, ?, ?, ?, ?,?,?,?)");
                        $stmt->bind_param("sssssssii", $transaction_id, $email, $gcash_name, $gcash_num,$ref_num, $newImageName, $subs, $userId, $propertyID);
                        ...
                        if ($stmt->execute()) {
                            ...
                            //notif
                            $freeTrialNotif= "Your premium payment is being verified. We'll notify you soon";
...
<div class="container bg-light d-md-flex align-items-center"> 
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center justify-content-between text mb-4"> 
                        <span>Fee</span> <span class="fas fa-peso-sign">
                            <span class="ps-1">200.00</span></span> 
                </div>
 ...
 <div class="d-flex align-items-center justify-content-between text mt-1">
...
<div class="modal fade" id="qrModal" tabindex="-1" aria-labelledby="qrModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal fade" id="qrModal" tabindex="-1" aria-labelledby="qrModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                    <img src="<?= htmlspecialchars($qr_image) ?>" alt="QR Code" style="width: 100%; height: 100%;" >
                    </div>
                    <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
    ...
    <div class="card box2 shadow-sm">
         <div class="d-flex align-items-center justify-content-between p-md-5 p-4"> 
                            <span class="h5 fw-bold m-0">Premium Subscription</span>
            ...
            <li class="nav-item">
                ...
                <form  class="payment-form" action="premium-payment.php" method="post" enctype="multipart/form-data" style="display:yes;">
                    ...
                    <div class="d-flex flex-column px-md-5 px-4 mb-4"> 
                        ...
                        <button    class="field_btn" onclick="showForm(2)">Next   </button >
                        </div>
